...
namespace OpenRouterSDK.Models.Requests
{
    ...
    {
        public static readonly ApiType Completions = new ApiType("completions");
        public static readonly ApiType Embeddings = new ApiType("embeddings");
